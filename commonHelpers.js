...
</li>`}const S="/goit-js-hw-12/assets/close-06de2d57.svg",r={searchForm:document.querySelector(".search-form"),gallery:document.querySelector(".gallery"),loader:document.querySelector(".loader"),loadMoreBtn:document.querySelector(".load-more-btn")},m=new w(".gallery a",{captionsData:"alt",captionDelay:350});let c="",i=1,g=1;const v=15;r.searchForm.addEventListener("submit",P);async function P(e){if(e.preventDefault(),c=e.target.elements.searchField.value.trim(),i=1,c===""){r.gallery.innerHTML="",n("You forgot enter data for search","#ffa000");return}u(r.loader);try{const{totalHits:o,hits:s}=await h(c,i);s.length===0&&(r.gallery.innerHTML="",n("Sorry, there are no images matching your search query. Please try again!","#EF4040")),g=Math.ceil(o/v);const l=p(s);r.gallery.innerHTML=l,m.refresh()}catch(o){console.log(o),n("An error occurred while fetching photos. Please try again later.","#EF4040")}finally{e.target.reset(),f(r.loader)}y()}r.loadMoreBtn.addEventListener("click",B);async function B(){u(r.loader),i++;try{const{hits:e}=await h(c,i),o=p(e);r.gallery.insertAdjacentHTML("beforeend",o),m.refresh(),E()}catch(e){console.log(e),n("An error occurred while fetching photos. Please try again later.","#EF4040")}finally{f(r.loader)}y()}function n(e,o){b.show({message:e,position:"topRight",backgroundColor:o,iconUrl:S,messageColor:"#fff",theme:"dark",maxWidth:"350px"})}function y(){i===g?(f(r.loadMoreBtn),n("We're sorry, but you've reached the end of search results.","#ffa000"),r.searchForm.reset()):u(r.loadMoreBtn)}function f(e){e.classList.add("visually-hidden")}function u(e){e.classList.remove("visually-hidden")}function E(){const o=r.gallery.children[0].getBoundingClientRect().height;window.scrollBy({top:o*2,behavior:"smooth"})}
